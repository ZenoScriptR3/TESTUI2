...
loadSub.BackgroundTransparency=1; loadSub.Text="VER. 3  |  TEST3 EDITION"
...
loadCredit.BackgroundTransparency=1; loadCredit.Text="By ZENOSCRIPTR3  •  Co-pilot: C4.6 & D3"
...
loadStatus.Size=UDim2.new(0,300,0,16); loadStatus.Position=UDim2.new(0.5,-150,0.75,10)
loadStatus.BackgroundTransparency=1; loadStatus.Text="Initializing..."
loadStatus.TextColor3=Color3.fromRGB(120,120,120); loadStatus.TextSize=18
...
subLbl.Text="VER. 3.0 | TESTUI3"; subLbl.TextColor3=C_RED
...
sectionFunctions["OTHERS"]=function()
    ...
    createInfoLabel("Co-pilot: C4.6 & D3")
    createInfoLabel("Version: TEST3 Edition")
    createInfoLabel("Info:" .. player.DisplayName .. "launched")
    createInfoLabel("All features working except cloud saves")
    createInfoLabel("So i remove them")
end
